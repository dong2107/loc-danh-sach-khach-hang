<?php
$customer_list = array(
    "1" => array("name" => "Nguyễn Quốc Khánh", "day_of_birth" => "1983/09/02", "address" => "Hà Nội", "profile" => "images/img1.jpg"),
    "2" =>array("name" => "Đỗ Quang Trung", "day_of_birth" => "1983/05/18", "address" => "Bắc Giang", "profile" => "images/img2.jpg"),
    "3" =>array("name" => "Trần Thu Trang", "day_of_birth" => "1999/04/12", "address" => "Nam Định", "profile" => "images/img3.jpg"),
